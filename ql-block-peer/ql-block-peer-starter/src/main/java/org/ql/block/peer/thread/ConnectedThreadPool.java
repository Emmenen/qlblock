...
@Service
@Slf4j
public class ConnectedThreadPool {
    @Autowired
                ...
                while (true){
                    ...
                    switch (header) {
                        ...
                        case GOSSIP_TEXTDATA:
                            ...
                            break;
                        case SALVE_APPLY:
                            log.info("SALVE_APPLY");
                            SalveApplyMessage salveApplyMessage = (SalveApplyMessage) message;
                            gossipService.gossipSpread(salveApplyMessage,MessageType.SALVE_APPLY);
                            break;
                    }
                }
            } catch (IOException e) {
